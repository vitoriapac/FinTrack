...
const invalidFinance={...base,cartoes:[{id:'bad-card',nome:'Inválido',limite:-1,fechamento:40,vencimento:0}],dividas:[{id:'bad-debt',credor:'Inválida',saldo:-1,juros:-2,parcelasRestantes:-1}],metas:[{id:'bad-goal',nome:'Inválida',alvo:0,acumulado:-1,aporte:0}]};
const invalidReport=validation.validateData(invalidFinance);
