...
assert.deepEqual(Object.keys(projected.meses[0].confirmado),['entradas','saidas','investimentos']);assert.deepEqual(Object.keys(projected.meses[0].planejado),['entradas','saidas','investimentos']);assert.ok(Object.hasOwn(projected.meses[0].projetado,'saldoFinal'));assert.ok(projected.meses[0].orcamentoRestante>=0);assert.equal(projected.meses[0].entradas,projected.meses[0].projetado.entradas);
