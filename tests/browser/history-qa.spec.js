...
test('QA responsivo mantém a aplicação dentro de cinco viewports',async({page},testInfo)=>{
  ...
  for(const [width,height] of sizes){
    ...
    for(const view of [['Home','home'],['Lançamentos','lancamentos'],['Extrato financeiro','extrato'],['Agenda','agenda'],['Balanço','balanco'],['Visão anual','anual'],['Patrimônio','patrimonio'],['Histórico','historico'],['Planejamento','planejamento'],['Projeção','projecao'],['Metas','metas'],['Cartões','cartoes'],['Dívidas','dividas'],['Cenários','simuladores'],['Auditoria','auditoria'],['Instalação','instalacao'],['Cadastro','cadastro']]){
...
test('QA estrutural mantém nomes acessíveis, ids únicos e console limpo',async({page},testInfo)=>{
  ...
  for(const [view,target] of [['Home','home'],['Lançamentos','lancamentos'],['Extrato financeiro','extrato'],['Agenda','agenda'],['Balanço','balanco'],['Visão anual','anual'],['Patrimônio','patrimonio'],['Histórico','historico'],['Planejamento','planejamento'],['Projeção','projecao'],['Metas','metas'],['Cartões','cartoes'],['Dívidas','dividas'],['Cenários','simuladores'],['Auditoria','auditoria'],['Instalação','instalacao'],['Cadastro','cadastro'],['Instruções','instrucoes']]){
