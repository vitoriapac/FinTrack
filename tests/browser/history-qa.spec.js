...
test('QA responsivo mantém a aplicação dentro de cinco viewports',async({page},testInfo)=>{
  ...
  for(const [width,height] of sizes){
    ...
    for(const view of ['Home','Lançamentos','Vencimentos','Agenda','Balanço','Patrimônio','Histórico','Planejamento','Projeção','Metas','Cartões','Dívidas','Simuladores','Auditoria','Cadastro']){
