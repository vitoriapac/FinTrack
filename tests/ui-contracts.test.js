...
assert.ok(home.includes('FinancialSummary.render'));
assert.ok(home.includes('O que merece sua atenção'));
...
assert.ok(fs.readFileSync('js/views/metas.js','utf8').includes('delete-goal:'));
