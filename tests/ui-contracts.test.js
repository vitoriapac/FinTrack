...
assert.ok(html.includes('data-action="reverse-card-payment"'));
assert.ok(html.includes('data-action="reverse-debt-payment"'));
assert.ok(html.includes('Pagamentos de faturas'));
assert.ok(html.includes('Pagamentos de dívidas'));
...
assert.ok(html.includes('Antes da migração'));
assert.ok(html.includes('Pré-visualização da importação'));
assert.ok(html.includes('foi revertida integralmente'));
