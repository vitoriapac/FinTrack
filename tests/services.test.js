...
assert.equal(reversedCard.operacoes.find(item=>item.id==='op-card-1').lancamentoIds.length,0);
...
assert.equal(reversedDebt.operacoes.find(item=>item.id==='op-debt-1').lancamentoIds.length,0);
